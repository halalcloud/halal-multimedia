#ifndef RTMPHANDSHAKE_HPP
#define RTMPHANDSHAKE_HPP
...
public:
    ...
    bool completed();
    /**
     * @brief set_handshake_type 在handshake_with_server之前使用
     * @param complex
     */
    void set_handshake_type(bool complex);

private:
    int parse_complex_c0c1();
    int parse_complex_s0s1s2();
    int parse_complex_c2();

    int parse_simple_c0c1();
    int parse_simple_s0s1s2();
    int parse_simple_c2();

    int create_s0s1s2(const char *c1 = NULL);

private:
    int create_c0c1();
    int create_c2();

    int process_complex_c0c1();
    int process_complex_s0s1s2();
    int process_complex_c2();

    int process_simple_c0c1();
    int process_simple_s0s1s2();
    int process_simple_c2();

    _srs_internal::c1s1 *m_c1;
...
private:
    ...
    _srs_internal::c1s1 s1;
    _srs_internal::c2s2 s2;
